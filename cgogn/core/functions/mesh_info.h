...
template <typename CELL, typename MESH, typename std::enable_if_t<mesh_traits<MESH>::is_CMapBase>* = nullptr>
...
template <typename MESH, typename CELL>
auto is_incident_to_boundary(const MESH& m, CELL c) -> std::enable_if_t<mesh_traits<MESH>::is_CMapBase, bool>
{
