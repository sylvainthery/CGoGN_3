...
class PointsCloudRender : public ViewModule
{
	...
	struct Parameters
	{
		Parameters()
			: vertex_position_(nullptr), vertex_position_vbo_(nullptr),
			  vertex_scalar_(nullptr), vertex_scalar_vbo_(nullptr),
			  vertex_color_(nullptr),  vertex_color_vbo_(nullptr), 
			  vertex_radius_vbo_(nullptr),  vertex_point_color_vbo_(nullptr),
			  color_per_cell_(GLOBAL), color_type_(SCALAR),
			  point_color_per_cell_(GLOBAL), point_color_type_(VECTOR),
...
public:
	PointsCloudRender(const App& app)
		: ViewModule(app, "PointsCloudRender (" + std::string{mesh_traits<MESH>::name} + ")"),
...
protected:
	...
	void init() override
	{
		...
		connections_.push_back(boost::synapse::connect<typename MeshProvider<MESH>::mesh_added>(
			mesh_provider_, this, &PointsCloudRender<MESH>::init_mesh));
	}
