...
#ifndef CGOGN_MODULE_VOLUME_RENDER_DEF_H_
#define CGOGN_MODULE_VOLUME_RENDER_DEF_H_
...
class VolumeRenderDef : public ViewModule
{
		...
		if (selected_view_)
		{
			...
			if (selected_view_ && selected_mesh_)
			{
				...
				if (p.render_volumes_)
				{
					...
					{
						need_update |= ImGui::ColorEdit3("Volume color", p.data_.color_.data(),
														 ImGuiColorEditFlags_NoInputs);
					}
